...
![](https://res.cloudinary.com/dhwkzyl32/image/upload/q_65/v1662559396/radanfolio/projects/utimer/utimer-demo_urkgct.gif)

## The process

Utimer is a simple app, all it's logic is inside the a single component: [Main.js](https://github.com/radandevist/utimer/blob/master/src/pages/main/Main.js[utimer/Main.js at master · radandevist/utimer · GitHub](https://github.com/radandevist/utimer/blob/master/src/pages/main/Main.js)) and it doesn't use any native API inside it. All I've done is just to do some number calculations and use Javascript's timer funcions: `setInterval` and `clearInterval` to update some states which would be used for the counter's screening.
