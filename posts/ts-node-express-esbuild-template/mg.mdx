...
This article is a continuation of another post: [Setup a React and Typescript project boilerplate with Vite, TailwindCSS and ESlint](/posts/ts-vite-react-tailwind-template).
