...
SWC is Javascript transpiler as the same as Babel and it supports compiling Typescript too as an alternative to the official Typescript compiler. Written entirely in Rust in contrast to Babel and TSC, which are in plain Javascript.
...
There is how we do to configure SWC alongside Typescript. Wether the project type is in CommonJs or ES Modules, you are now ready to take by the horns. 😉
