---
title: Comment afficher un placeholder blurré pour le component Image de Next.js avec Cloudinary
...
excerpt: Lors de la création de mon blog avec Next.js, j'ai remarqué qu'un espace vide s'affichait avant que l'image réelle n'apparaisse lorsque j'utilise le component Image.
featured: true
---

Lors de la création de mon blog avec Next.js, j'ai remarqué qu'un espace vide s'affichait avant que l'image réelle n'apparaisse lorsque j'utilise le component Image.

Pour améliorer l'expérience utilisateur du contenu multimédia sur le site Web, il est préférable d'afficher une image floue avant que l'image fournie dans l'url prop ne se charge. Comme n'importe quel site de blog d'ailleurs!
